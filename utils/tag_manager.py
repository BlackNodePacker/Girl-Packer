...
class TagManager:
    ...
    def _load_all_data(self):
        ...
        self.clothing_modifiers = self._load_json_file('clothing_modifiers.json', self.asset_tags_dir)
    ...
    def add_event_definition(self, event_name, event_data):
        ...
        try:
            ...
            logger.info(f"Event '{event_name}' definition added/updated and saved to event_definitions.json")
            return True
    ...
    # --- Getters ---
    def get_shoots_config(self): return self.shoots_config
    def get_shoots_tags(self): return self.shoots_tags
    def get_vid_tags(self): return self.vid_tags
    def get_character_traits(self): return self.character_traits
    def get_clothing_definitions(self): return self.clothing_definitions
    def get_clothing_map(self): return self.clothing_map
    def get_bodyparts_map(self): return self.bodyparts_map
    def get_clothing_modifiers(self): return self.clothing_modifiers
    def get_fullbody_map(self): return self.fullbody_map
    ...
    def add_new_tag(self, file_key: str, base_key: str, display_name: str, tag_value: str):
        ...
        if not target_dict: 
            ...
            return False
        if base_key not in target_dict: target_dict[base_key] = {}
        ...
        try:
            ...
            logger.info(f"Successfully added '{display_name}' to '{base_key}' in {os.path.basename(file_path)}")
            return True
        except Exception as e:
