...
def create_thumbnail_from_video(video_path: str, target_size: int = 128):
    ...
    if os.path.exists(cache_path):
        try:
            ...
            if not image.isNull():
                ...
                logger.warning(f"Cache file was corrupt, regenerating: {os.path.basename(video_path)}")
    ...
    # Create QImage
    q_image = QImage(frame_rgb.data, new_width, new_height, 3 * new_width, QImage.Format.Format_RGB888)
